...
[{{ ciem-full-name }}](../../concepts/ciem.md) ({{ ciem-name }}) provides a centralized view of the full list of access permissions for the organization's [resources](../../../iam/concepts/access-control/resources-with-access-control.md) available to individual [subjects](../../../iam/concepts/access-control/index.md#subject) and groups.
